    ...
    <div className="w-full max-w-md">
      ...
      <div className="bg-white rounded-2xl shadow-sm p-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm font-medium text-[#2D3436] hover:bg-gray-100 transition-colors mb-4"
        >
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#833AB4] rounded-xl text-sm font-medium text-white hover:opacity-90 transition-opacity mb-6"
        >
